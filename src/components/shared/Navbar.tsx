    ...
    return (
        ...
        >
            <div className="navbar-brand">
                <a href="https://hm22-code.github.io/portfolio/" className="profile-link navbar-item">
                ...
                <div className="navbar-start">
                    ...
                    <div className='navbar-item has-dropdown is-hoverable'>
                        <a className="navbar-link is-arrowless">
                            <div className='is-flex is-align-items-center'>
                                ...
                                <p className='is-unselectable'>{t('navbar.part4')}</p>
                            </div>
                        </a>
                    ...
                    <a className="navbar-item" onClick={toggleDarkTheme}>
                        <div className='is-flex is-align-items-center'>
                            ...
                            {isDark ? <p className='is-unselectable'>{t('navbar.part7')}</p> : <p className='is-unselectable'>{t('navbar.part8')}</p>}
                        </div>
                    </a>
                </div>
            </div>
